 ...
 * `ARCA_*` / `RECEIVER_MATCHES_ISSUER` and their detail shapes live in `providers/arca/faults/faults.ts`).
 *
 ...
 *
 * Three kinds of input, and no fourth: the neutral errors declared in `providers/provider/provider.ts` (each with a
