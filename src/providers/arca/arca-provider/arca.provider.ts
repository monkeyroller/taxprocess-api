...
import {toCbteTipo, toPadronService} from '../mapping/code-maps/code-maps.js';
import {
    isNoResults,
    isPadronTicketFault,
    isVoucherNotFound,
...
export class ArcaProvider extends TaxEntityProvider {
     ...
     * method (the base class applies it). This is what keeps `http/error-mapper/error-mapper.ts` free of ARCA: the SDK's
